  ...
  return (
    <>
      <button
        ...
        onClick={handleOpen}
        className="fab-slot sos-fab fixed right-4 z-[120] grid size-14 place-items-center rounded-full bg-hu-red text-white shadow-sos-ring"
        style={{
          animationPlayState: !visible || open ? "paused" : "running",
        }}
      >
        <IconAlarm size={26} />
      </button>
        ...
        >
          ...
          >
            ...
            <button
              ...
              aria-label="Sluiten"
              onClick={() => setOpen(false)}
              className="press-feedback absolute right-4 top-5 grid size-9 place-items-center rounded-full text-ink-muted hover:text-ink"
            >
              <IconClose size={20} />
            </button>
            ...
            <button
              ...
              className="press-feedback sos-send-beat mt-5 flex w-full items-center justify-center gap-2 rounded-pill bg-hu-red px-6 py-4 text-display-md text-white disabled:opacity-60"
            >
              <IconAlarm size={20} />
              Verstuur paniek-app
            </button>
            ...
            <button
              type="button"
              onClick={() => setOpen(false)}
              className="press-feedback mt-2 w-full rounded-pill px-6 py-3 text-label-xs text-ink-muted"
            >
              Nee, het komt goed
            </button>
          </div>
